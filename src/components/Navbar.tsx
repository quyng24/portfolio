...
const Navbar = () => {
    ...
    return (
        <>
            <nav className={`fixed top-0 left-0 right-0 z-[60] w-full overflow-x-clip transition-all duration-500 ${scrolled
                ...
                <div className="mx-auto flex w-full max-w-7xl min-w-0 items-center justify-between gap-3 px-4 sm:px-6 lg:px-8">
                    ...
                    {/* Logo */}
                    <a href="#" className="flex min-w-0 max-w-[calc(100vw-5rem)] items-center gap-2 sm:max-w-none">
                        <div className="rounded-xl bg-blue-600 p-1.5 shadow-lg transition-transform duration-300 hover:rotate-12">
                            <Code2 size={20} className="text-white sm:size-[22px]" />
                        </div>
                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed right-0 top-0 h-full w-[280px] bg-white dark:bg-slate-900 z-[80] shadow-2xl md:hidden"
                        >
