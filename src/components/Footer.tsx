import { Mail, Send, MapPin, Phone, ArrowUpRight, GitBranchIcon, LineSquiggle } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                    ...
                    <div className="space-y-8">
                        <div>
                            <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-6 leading-tight">
                                Sẵn sàng cho những <br />
                                <span className="text-blue-500">thách thức mới?</span>
                            </h2>
                            <p className="text-slate-400 text-lg max-w-md">
                                Tôi luôn sẵn sàng thảo luận về các dự án tiềm năng hoặc những ý tưởng sáng tạo. Đừng ngần ngại liên hệ nhé!
                            </p>
                        </div>
                        ...
                        <div className="grid gap-4">
                            <a href="mailto:nguyenvanquy@email.com" className="group flex items-center gap-4 p-4 rounded-2xl bg-slate-900/50 border border-slate-800 hover:border-blue-500/50 transition-all duration-300">
                                ...
                                <div>
                                    <p className="text-xs text-slate-500 font-bold uppercase tracking-wider">Gửi Email</p>
                                    <p className="text-white font-medium">nguyenvanquy@email.com</p>
                                </div>
                    ...
                    <div className="flex flex-col justify-between">
                        <div className="grid grid-cols-2 gap-8 md:gap-16">
                            <div className="space-y-6">
                                <h4 className="text-white font-bold text-lg">Mạng xã hội</h4>
                                <ul className="space-y-4">
                                    <li>
                                        <a href="#" className="flex items-center gap-2 text-slate-400 hover:text-white transition-colors">
                                            <GitBranchIcon size={20} /> GitHub
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" className="flex items-center gap-2 text-slate-400 hover:text-white transition-colors">
                                            <LineSquiggle size={20} /> LinkedIn
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="space-y-6">
                                <h4 className="text-white font-bold text-lg">Điều hướng</h4>
                                <ul className="space-y-4">
                                    <li><a href="#projects" className="text-slate-400 hover:text-white transition-colors">Dự án</a></li>
                                    <li><a href="#techstack" className="text-slate-400 hover:text-white transition-colors">Kỹ năng</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="mt-12 lg:mt-0">
                            <a href="mailto:your@email.com" className="inline-flex items-center gap-3 px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-2xl shadow-lg shadow-blue-600/20 transition-all active:scale-95 group">
                                Nói Xin Chào!
                ...
                <div className="pt-12 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="text-slate-500 text-sm">
                        © {currentYear} Nguyễn Văn Quý. All rights reserved.
                    </div>
